...
def main():
    ...
    ax1.plot(df['step'], df['power_in'], color='gray', linewidth=1, label='power_in (requested)')
    ax1.plot(df['step'], df['power'], color='tab:blue', linewidth=1.5, label='power (actual)')
    ...
    ax2.plot(df['step'], df['soc_after'], color='tab:orange', linewidth=1.5)
    ...
    ax3.plot(df['step'], df['surplus'], color='tab:green', linewidth=1, label='surplus')
    ax3.plot(df['step'], df['deficit'], color='tab:red', linewidth=1, label='deficit')
    ...
    ax1.plot(steps, prod, color='tab:green', linewidth=1, label='production')
    ax1.plot(steps, dem, color='tab:red', linewidth=1, label='demand')
    ax1.plot(steps, prod - dem, color='tab:blue', linewidth=1.5, linestyle='--', label='net (prod-dem)')
    ax1.axhline(0, color='black', linewidth=0.5)
    ax1.set_ylabel('Power [kW]')
    ...
    ax2.plot(steps, soc_b1, color='tab:blue', linewidth=1.5, label=f'b1 SOC (cap={b1.cap}kWh)')
    ax2.plot(steps, soc_b2, color='tab:orange', linewidth=1.5, label=f'b2 SOC (cap={b2.cap}kWh)')
    ax2.plot(steps, soc_ev, color='gray', linewidth=1, linestyle='--', label='SOC weighted avg')
    ...
    ax3.plot(steps, pfs_ev, color='tab:green', linewidth=1, label='power_from_source (total)')
    ax3.plot(steps, supply_ev, color='tab:red', linewidth=1, label='supply (total)')
    ax3.plot(steps, surplus_ev, color='tab:cyan', linewidth=1, label='surplus')
    ax3.plot(steps, deficit_ev, color='tab:pink', linewidth=1, label='deficit')
