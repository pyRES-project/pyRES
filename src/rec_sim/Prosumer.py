...
class Prosumer:
    ...
    def economic_performance(self, time_horizon, tax_rate, int_rate, other_capex_perc, en_flows_and_prices):
        ...
        :param en_flows_and_prices: dict--> e.g. annnual_en_flows={'electricity':{'sold':100,'self_cons':200,'purchased':10,'price_sold':2,'price_buy':3,'decay':0.02}}
        ...
        calculator = Economics(components=self.systems+self.bess, en_flows_and_prices=en_flows_and_prices)
