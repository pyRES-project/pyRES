...
users_dict = {
    "user0": {"id": "0", "carriers": {"electricity": {"column": "user0"}}},
    "user1": {"id": "1", "carriers": {"electricity": {"column": "user1"}}},
    "user2": {"id": "2", "carriers": {"electricity": {"column": "user2"}}},
    "user3": {"id": "3", "carriers": {"electricity": {"column": "user3"}}},
    "user4": {"id": "4", "carriers": {"electricity": {"column": "user4"}}},
    "user5": {"id": "5", "carriers": {"electricity": {"column": "user5"}}},
    "user6": {"id": "6", "carriers": {"electricity": {"column": "user6"}}},
    "user7": {"id": "7", "carriers": {"electricity": {"column": "user7"}}},
    "user8": {"id": "8", "carriers": {"electricity": {"column": "user8"}}},
    "user9": {"id": "9", "carriers": {"electricity": {"column": "user9"}}},
    "user10": {"id": "10", "carriers": {"electricity": {"column": "user10"}}},
    "user11": {"id": "11", "carriers": {"electricity": {"column": "user11"}}},
    "user12": {"id": "12", "carriers": {"electricity": {"column": "user12"}}},
    "user13": {"id": "13", "carriers": {"electricity": {"column": "user13"}}},
    "user14": {"id": "14", "carriers": {"electricity": {"column": "user14"}}},
    "user15": {"id": "rec_load", "carriers": {"electricity": {"column": "user15"}}},
}
             ...
             'bess2':
                 {'tech': {"id": "bess2", 'cap': 10.24, 'c_rate': 1.0,
                  ...
                  'economics': {'cap_cost': 450, 'opex_cost': 20, 'inc_year':min(0.5*450*2.560*2*2,96000)/10, 'inc_start_end': [1, 10],
                                ...
                                'other_rev': {'item1': {'unit': 0, 'rev_unit': 0, 'dur': [0, 0]}}}, },
             'bess3':
                 {'tech': {"id": "bess3", 'cap': 10.24, 'c_rate': 1.0,
                           'soc_in': 0.2, 'soc_max': 1, 'soc_min': 0.2,
                           **bess_common_tech_params},
...
prosumers_dict = {
    "prosumer1": {'tech': {'id': 'PoloCentrale', 'carriers': ['electricity'], 'users': ['user0','user1','user2','user3','user4','user5','user6','user7','user8','user9','user10'],
                           'systems': ['pv1','pv2','pv3'],
                           'bess': []},
                  "economics": {
                      "tax_rate": 0.2,
    ...
    "prosumer2": {'tech': {'id': 'prosumer2', 'carriers': ['electricity'], 'users': ['user11'],
                           'systems': ['pv4'],
                           'bess': []},
                  "economics": {
                      "tax_rate": 0.2,
    ...
    "prosumer3": {'tech': {'id': 'prosumer2', 'carriers': ['electricity'], 'users': ['user12'],
                           'systems': ['pv5'],
                           'bess': []},
                  "economics": {
                      "tax_rate": 0.2,
...
rec_dict = {'rec1': {'tech': {
    ...
    'prosumers': ['prosumer1', 'prosumer2','prosumer3'],
    'consumers': ['user13','user14','user15'],
    'rec_systems': [], 'bess': [],
    'rec_users': []},
